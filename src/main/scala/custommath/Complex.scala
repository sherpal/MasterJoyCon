...
object Complex {
  ...
  val zero: Complex = ComplexIsFractional.zero

  given Conversion[Double, Complex]           = Complex(_, 0)
  given Conversion[Int, Complex]              = Complex(_, 0)
  given Conversion[Long, Complex]             = l => Complex(l.toDouble, 0)
  given Conversion[(Double, Double), Complex] = z => Complex(z._1, z._2)
